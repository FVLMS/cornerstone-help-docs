---
title: "Express Class"
description: "Create an Express Class and record attendee completion in Cornerstone."
navTitle: "Express Class"
...
- Confirm the date, time, subject, and length of the training or huddle.
...
1. From the home page, go to **Menu > Content Management > Express Class**.
2. Select **Create New Training**.
